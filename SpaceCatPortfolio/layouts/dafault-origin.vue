      ...
      <div class="row">
        <!-- <moso-sidenav ref="sidenav">
          ...
          <div class="profile-picture">
            <div class="media">
              <div class="image">
                <img src="/images/profile.jpg" alt="Space Cat AKA Gyuri">
              </div>
          ...
          <moso-drawer-list ref="drawerList">
            <li>
              <nuxt-link
                to="/profile"
                :class="{'router-link-active': $route.fullPath ==='/' || $route.fullPath === '/profile'}"
              >
