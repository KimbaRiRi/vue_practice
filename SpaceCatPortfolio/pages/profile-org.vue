      ...
      <div class="lg:5 xl:4 profile-widgets">
        <div class="widget">
          <div class="widget__body" v-for="title in titles" :key="title.id">
            <moso-profile
              ...
              name="Space Cat AKA Gyuri"
              :position="title.title"
            >
              <profile-item
                v-for="item in devicons"
                :key="item.id"
                :link="item.url"
        ...
        <div class="widget">
          ...
          <div class="widget__body">
            ...
            <a
              href="/files/morten-sorensen-cv-2019.pdf"
              class="button button-dark button--raised"
              ...
              <div class="widget__header">
                <h3 class="title">
                  <svg viewBox="0 0 16 16" id="info-svg">
                    <path
                      d="M 7.5 1 C 3.917969 1 1 3.917969 1 7.5 C 1 11.082031 3.917969 14 7.5 14 C 11.082031 14 14 11.082031 14 7.5 C 14 3.917969 11.082031 1 7.5 1 Z M 7.5 2 C 10.542969 2 13 4.457031 13 7.5 C 13 10.542969 10.542969 13 7.5 13 C 4.457031 13 2 10.542969 2 7.5 C 2 4.457031 4.457031 2 7.5 2 Z M 7 4 L 7 5 L 8 5 L 8 4 Z M 7 6 L 7 11 L 8 11 L 8 6 Z "
                    ></path>
                  </svg>
                  Information
                </h3>
                  ...
                  <div class="column">
                    ...
                    <div class="column-item column-item--right">
                      <div class="code-highlight">
                        <div>
                          <span class="red">let</span> $x
                          <span class="red">=</span>
                          <span class="blue">'morten'</span>;
                        </div>
                        <div>
                          <span class="red">let</span> $y
                          <span class="red">=</span>
                          <span class="blue">'moso'</span>;
                        </div>
                        <div>&nbsp;</div>
                        <div>
                          <span class="purple">console</span>.
                          <span class="blue">log</span>($x
                          <span class="red">+</span>
                          <span class="blue">'&#64;'</span>
                          <span class="red">+</span> $y
                          <span class="red">+</span>
                          <span class="blue">'.io'</span>);
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="widget__header">
                <h3 class="title">
                  <svg viewBox="0 0 16 16" id="tool-svg">
                    <path
                      d="M 6.5 1 C 5.675781 1 5 1.675781 5 2.5 L 5 3 L 2.5 3 C 1.648438 3 1 3.753906 1 4.609375 L 1 12.386719 C 1 13.246094 1.648438 14 2.503906 14 L 13.496094 14 C 14.351563 14 15 13.242188 15 12.386719 L 15 4.613281 C 15 3.753906 14.351563 3 13.5 3 L 11 3 L 11 2.5 C 11 1.675781 10.324219 1 9.5 1 Z M 6.5 2 L 9.5 2 C 9.78125 2 10 2.21875 10 2.5 L 10 3 L 6 3 L 6 2.5 C 6 2.21875 6.21875 2 6.5 2 Z M 2.5 4 L 13.5 4 C 13.75 4 14 4.242188 14 4.613281 L 14 7 L 2 7 L 2 4.609375 C 2 4.242188 2.25 4 2.5 4 Z M 2 8 L 4 8 L 4 9 L 6 9 L 6 8 L 10 8 L 10 9 L 12 9 L 12 8 L 14 8 L 14 12.386719 C 14 12.757813 13.75 13 13.496094 13 L 2.503906 13 C 2.25 13 2 12.757813 2 12.386719 Z "
                    ></path>
                  </svg>
                  Toolbox
                </h3>
...
export default {
  ...
  head() {
    return {
      title: "Space Cat AKA Gyuri | " + this.title
    };
  },
...
.code-highlight {
  ...
  font-family: "Liberation Mono", "SFMono-Regular", Consolas, Menlo, Courier,
    monospace;
  font-size: 80%;
  color: #000;
  line-height: 1.45;
